 ...
 <div x-data="sales">
    <ul class="flex space-x-2 rtl:space-x-reverse">
        ...
        <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
            <span>Create ExpenseCategories Page</span>
        </li>
    </ul>
    <!-- start main content section -->
    <div class="container my-3  float-right">
      <div class="d-flex justify-content-between  float-right">
          <button class="btn btn-info btn-sm"><a href="{{'/expensecategories'}}">Go to ExpenseCategories</a></button>
      </div>
    </div>
  ...
  <div class="card-body">
    ...
    <form action="{{ route('expensecategories.store') }}" method="post">
      ...
      <div class="form-group">
        ...
        <input type="text" id="name" name="name" class="form-control mb-4" placeholder="Enter expense category name">
      </div>
