                                        ...
                                        <div class="card border shadow-0 m-2">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="text-center ml-3">
                                                        @foreach ($product->productColors as $key => $productColor)
                                                            <div class="d-flex">
                                                                <div class="d-flex returns-details mr-3">
                                                ...
                                                <button class="btn btn-success w-100 shadow-0 mt-2"
                                                    onclick="addToCart({{ $product->productColors }}, {{ $product->price }})">Return</button>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                        ...
                        <div class="card shadow-0 border">
                            <div class="card-body">
                                ...
                                <div class="mt-3  d-flex">
                                    <form action="{{ route('return.store') }}" style="width: 100%" id="form-purchase"
                                        method="POST">
                                        @csrf
                                        ...
                                        <div class="d-flex">
                                            <button type="reset" style="width: 50%"
