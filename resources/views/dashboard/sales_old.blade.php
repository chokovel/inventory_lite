                        ...
                        <div class="card border shadow-0 mb-3">
                            <div class="row gy-3 mb-4 d-flex">
                                <div class="d-flex p-4">
                                    ...
                                    <div
                                        class="col-lg-6 col-sm-6 col-6 d-flex flex-row flex-lg-column flex-xl-row text-nowrap">
                                ...
                                <div class="row gy-3 mb-4">
                                    <div class="col-lg-4">
                                        <div class="me-lg-4">
                                            <div class="d-flex">
                                                <img src="https://kesagroup.net/cdn/shop/products/Karungi_africanMapYellow_580x.jpg?v=1658244703"
                                                    class="border rounded me-3 center"
                                                    style="width: 96px; height: 96px; margin: 0 auto;" />
                                                <div class="text-center">
                                                    <a href="#" class="nav-link">Winter jacket for men and lady</a>
                                                    <p class="text-muted">₦21000</p>
                                    ...
                                    <div
                                        class="col-lg col-sm-6 justify-content-sm-center justify-content-md-start justify-content-lg-center justify-content-xl-end mb-2">
                                        <div class="d-flex">
                                            <div class="d-flex sales-details">
                                                <p class="d-flex"><span> M </span style="color:darkred"> | <span> Yellow
                                                    </span></p>
                                            </div>
                        ...
                        <div class="card shadow-0 border">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    ...
                                    <a href="{{ '/products' }}" class="btn btn-light w-100 border mt-2"> Back to shop
                                    </a>
                                </div>
                            </div>
                        </div>
