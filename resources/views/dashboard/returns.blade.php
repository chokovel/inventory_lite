...
<section class="bg-light my-5">
  <div class="container sales-section">
    <div class="row">
        <h4 class="card-title mb-3 me-3">Your Product Return Cart</h4>
      <!-- cart -->
      <div class="col-lg-4">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-9">
        <div class="card border shadow-0">
          <div class="m-4">
            <h2 class="text-large mb-2"><strong>Product Returns Summary</strong></h2>
        ...
        <div class="card shadow-0 border">
          <div class="card-body">
            <div class="d-flex justify-content-between">
              <p class="mb-2">Previous Qty:</p>
              <p class="mb-2">105</p>
            </div>
            <div class="d-flex justify-content-between">
              <p class="mb-2">Returned Qty:</p>
              <p class="mb-2">5</p>
              {{-- <input style="width: 63px" class="mb-2 text-success" type="number" placeholder="₦0.00"  /> --}}
            </div>
            <hr />
            <div class="d-flex justify-content-between">
              <p class="mb-2">New Total Qty:</p>
              <p class="mb-2 fw-bold"> 110</p>
            </div>

            <div class="mt-3">
              <a href="#" class="btn btn-success w-100 shadow-0 mb-2"> Make Returns </a>
